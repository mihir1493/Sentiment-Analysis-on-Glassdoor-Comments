...
class GlassdoorSpiderSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.glassdoor.com/Reviews/Wells-Fargo-Reviews-E8876.htm']
...
# Pagination done through the next page element, helps cycle the scraping process across each page till it reaches the limit set by user below. 
        next_page = "https://www.glassdoor.com/Reviews/Wells-Fargo-Reviews-E8876_P"+ str(GlassdoorSpiderSpider.page_number) +".htm?filter.iso3Language=eng"
        if GlassdoorSpiderSpider.page_number <= 1000:
